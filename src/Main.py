...
from KNN import k_means_cluster, edited_nearest_neighbors_classification
...
edited_dataset = edited_nearest_neighbors_classification(train_data, train_labels, 0.1)
...
edited_dataset = edited_nearest_neighbors_classification(train_data, train_labels, 0.01)
